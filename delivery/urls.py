...
urlpatterns = [
    ...
    path('open_update_menu/<int:item_id>', views.open_update_menu, name='open_update_menu'),

    path('update_menu/<int:item_id>', views.update_menu, name='update_menu'),

    path('delete_menuItem/<int:item_id>', views.delete_menuItem, name='delete_menuItem'),
    ...
    path('payment_verify/<str:username>/', views.payment_verify, name='payment_verify'),
